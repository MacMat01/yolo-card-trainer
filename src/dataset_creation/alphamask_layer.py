...
alphamask= np.ones((cardHeight, cardWidth), dtype=np.uint8) * 255
cv2.rectangle(alphamask, (0,0), (cardWidth - 1, cardHeight - 1), 0, bord_size)
cv2.line(alphamask,(bord_size*3,0),(0,bord_size*3),0,bord_size)
cv2.line(alphamask, (cardWidth - bord_size * 3, 0), (cardWidth, bord_size * 3), 0, bord_size)
cv2.line(alphamask, (0, cardHeight - bord_size * 3), (bord_size * 3, cardHeight), 0, bord_size)
cv2.line(alphamask, (cardWidth - bord_size * 3, cardHeight), (cardWidth, cardHeight - bord_size * 3), 0, bord_size)
...
def extract_card(img, output_fn=None, min_focus=1, debug=False):
    ...
    if valid:
        ...
        imgwarp = cv2.warpPerspective(img, Mp, (cardWidth, cardHeight))
        # Add alpha layer
